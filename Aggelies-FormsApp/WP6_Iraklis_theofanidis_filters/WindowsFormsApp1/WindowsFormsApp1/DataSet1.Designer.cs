...
namespace WindowsFormsApp1 {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class productDataTable : global::System.Data.TypedTableBase<productRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public productRow AddproductRow(string Title, string Description, float Price, int Category, string Image) {
...
namespace WindowsFormsApp1.DataSet1TableAdapters {
    ...
    public partial class productTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `product` WHERE ((`ID` = ?) AND ((? = 1 AND `Title` IS NULL) OR (`Tit" +
                "le` = ?)) AND ((? = 1 AND `Price` IS NULL) OR (`Price` = ?)) AND ((? = 1 AND `Ca" +
                "tegory` IS NULL) OR (`Category` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `product` (`Title`, `Description`, `Price`, `Category`, `Image`) VALU" +
                "ES (?, ?, ?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `product` SET `Title` = ?, `Description` = ?, `Price` = ?, `Category` = ?, `Image` = ? WHERE ((`ID` = ?) AND ((? = 1 AND `Title` IS NULL) OR (`Title` = ?)) AND ((? = 1 AND `Price` IS NULL) OR (`Price` = ?)) AND ((? = 1 AND `Category` IS NULL) OR (`Category` = ?)))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Title, Description, Price, Category, [Image] FROM product";
        ...
        public virtual int Delete(int Original_ID, string Original_Title, global::System.Nullable<float> Original_Price, global::System.Nullable<int> Original_Category) {
        ...
        public virtual int Insert(string Title, string Description, global::System.Nullable<float> Price, global::System.Nullable<int> Category, string Image) {
            if ((Title == null)) {
        ...
        public virtual int Update(string Title, string Description, global::System.Nullable<float> Price, global::System.Nullable<int> Category, string Image, int Original_ID, string Original_Title, global::System.Nullable<float> Original_Price, global::System.Nullable<int> Original_Category) {
            if ((Title == null)) {
            ...
            if ((Original_Price.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[9].Value = ((float)(Original_Price.Value));
            }
            else {
