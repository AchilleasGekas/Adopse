...
namespace WindowsFormsApp1.DataSet2TableAdapters {
    ...
    public partial class productTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `product` WHERE (((? = 1 AND `Title` IS NULL) OR (`Title` = ?)) AND (" +
                "`ID` = ?))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `product` (`Title`) VALUES (?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `product` SET `Title` = ? WHERE (((? = 1 AND `Title` IS NULL) OR (`Title` " +
                "= ?)) AND (`ID` = ?))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT        Title, ID\r\nFROM            product\r\nWHERE        (ID > 5)";
        ...
        public virtual int Update(string Title, string Original_Title, int Original_ID) {
            if ((Title == null)) {
